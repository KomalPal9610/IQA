...
class IQADataset(torch.utils.data.Dataset):
    def __init__(self, scale, db_path, txt_file_name, transform, train_mode, scene_list, train_size=0.8):
    ...
    def __getitem__(self, idx):
        ...
        r_img = self.scaling(r_img,self.scale)
        ...
        d_img = self.scaling(d_img,self.scale)
